...
@Component({
  selector: 'ServiceBooking-home',
  templateUrl: './ServiceBooking-home.component.html',
  styleUrls: ['./ServiceBooking-home.component.scss']
})
export class ServiceBookingHomeComponent implements AfterViewInit {
