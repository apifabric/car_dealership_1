...
@Component({
  selector: 'CarAccessory-home',
  templateUrl: './CarAccessory-home.component.html',
  styleUrls: ['./CarAccessory-home.component.scss']
})
export class CarAccessoryHomeComponent implements AfterViewInit {
