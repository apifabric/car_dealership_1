...
@Component({
  selector: 'InventoryAudit-home',
  templateUrl: './InventoryAudit-home.component.html',
  styleUrls: ['./InventoryAudit-home.component.scss']
})
export class InventoryAuditHomeComponent implements AfterViewInit {
