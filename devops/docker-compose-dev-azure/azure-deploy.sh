...
resourcename="cardealership1"  # lower case, only
resourcegroup="cardealership1_rg"
...
# git clone https://github.com/apilogicserver/cardealership1.git
# cd cardealership1
...
az group create --name cardealership1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealership1_rg --sku S1 --is-linux
az container create --resource-group cardealership1_rg --name cardealership1 --image apilogicserver/cardealership1:latest --dns-name-label cardealership1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealership1.westus.azurecontainer.io:5656'
