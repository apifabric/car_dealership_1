...
@Component({
  selector: 'ServicePackage-home',
  templateUrl: './ServicePackage-home.component.html',
  styleUrls: ['./ServicePackage-home.component.scss']
})
export class ServicePackageHomeComponent implements AfterViewInit {
